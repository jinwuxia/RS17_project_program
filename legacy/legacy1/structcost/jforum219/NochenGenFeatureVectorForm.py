...
def processList(listList):
    ...
    for each in listList:
        ...
        if fromClassID != -1 and toClassID != -1:
            depM[fromClassID][toClassID] = deps
        else:
            print fromClassName, fromClassID, toClassName, toClassID

# based on the standard class file
# transfrom [fromclass, toclass, deps] into matrix_dependency
#python pro.py   standardClassListFile    sanweidepFile    outMatrixFile  pre    
