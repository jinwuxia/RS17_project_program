...
#python pro.py   struct.csv   distFunc=coupling,jm, uem, uemnm       mergeFunc= MIN_SINGLE, MAX_SINGLE, AVG       K=iterNum  classListFile   clusterFile    struct/commu
oneAlg = AlgClass()
