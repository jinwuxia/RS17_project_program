...
def smoothClusterFv(cluster2ClassList, SMOOTH_THR):
...
def analyzeOneCluster(clusterFileName, featureVectorFileName, classFileName):
    ...
    newClusterFvList = smoothClusterFv(clusterFvList, SMOOTH_THR)
    ...
    [nonOverlappedClassCount,  nonOverlappedAvg, overlappedClassCount, overlappedAvg, high_overlappedClassCount, high_overlappedAvg, low_overlappedClassCount, low_overlappedAvg] = totalMetic(classID2ClusterDict, allOverlapClassID2ClusterDict, highClassID2ClusterDict, lowClassID2ClusterDict)
    return nonOverlappedClassCount,  nonOverlappedAvg, overlappedClassCount, overlappedAvg, high_overlappedClassCount, high_overlappedAvg, low_overlappedClassCount, low_overlappedAvg
