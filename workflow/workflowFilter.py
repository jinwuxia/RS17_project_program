...
#filterTrace
filterTraceName = "net.jforum.JForum.service"

part1EndMethodName = "net.jforum.Command.<init>()"
#= "net.jforum.context.web.WebRequestContext.getAction"
#= "net.jforum.context.web.WebRequestContext.getParameter"

part2EndMethodName = "net.jforum.JForum.handleFinally"
...
def ProcessTrace():
    part1EndMethodID = GetFilterPart1End(part1EndMethodName)
    part2EndMethodID = GetFilterPart2End(part2EndMethodName)
    filterID = GetFilterTraceID(filterTraceName)
    print part1EndMethodID, part2EndMethodID, filterID

    for traceID in range(0, len(TRACEList)):
        methodList =  TRACEList[traceID]
        if filterID != methodList[0]:
            continue
        oneList = list()
        oneList.append(dict())
        oneList.append(dict())
